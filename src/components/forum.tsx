      ...
      <div className="row">
        <nav className="col-md-3 col-lg-2 sidebar bg-light p-3">
          ...
          <ul className="nav flex-column">
            {["General", "News", "Knowledge", "Articles", "Project"].map(
              (item) => (
            ...
            <div className="card discussion-card mb-3" key={index}>
              <div className="card-body d-flex flex-column">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <h6 className="card-subtitle mb-2 text-muted p-2">
                        {discussion.author} started {discussion.time}
                      </h6>
                    </div>
                  </div>
                  <span
                ...
                <p className="card-text mt-2">
                  Wildlife conservation is a pressing concern that requires our
                  attention...
                </p>
                <div className="d-flex justify-content-between align-items-center mt-auto">
                  ...
                  <div className="d-flex align-items-center">
                    <span className="me-2">
                      {discussion.comments.length} <FaComment />
                    </span>
                    <span className="me-2">
